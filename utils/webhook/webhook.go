...
const (
	admissionWebhookAnnotationInjectKey = "sidecar-injector-webhook.mmtrix.io/inject"
	admissionWebhookAnnotationStatusKey = "sidecar-injector-webhook.mmtrix.io/status"
)
